...
---
✋<i>반갑습니다! 프론트엔드 개발자 입니다!</i>🎸<br><br>

<div align="center">
  <table>
    <tr>
      <td><img src="https://github.com/user-attachments/assets/c10ac529-c0df-414e-8f7c-8724d8c9806f" alt="main" width="300"/></td>
      <td>
        <pre>
const Me = {
    name : "박준서",
...
#### 2020
- 1학기 학기우등 (4.15)
- 2020.07.28 ~ 2022.01.29: 7군단 정보통신단 운전병 복무
---
#### 2022
- 1학기 학기우등 (4.16)
- 교내 학술동아리 C.愛.랑 앱 개발(라떼) 팀원
- 교내 SW Week 동아리 전시회 앱 부분 참여 (미니게임 파라다이스 - 안드로이드 모바일 게임)
- 교내 SW중심대학사업단 전공 멘토링 프로그램 멘티 (Python)
- 교내 학술동아리 C.愛.랑 하계 SW 워크샵 참여
- 교내 2학기 VR/AR 게임 제작 기초 과목 Unity 개발 (RUPIR - 3D 공포 장르 게임)
---
#### 2023
- 1학기 학기우등 (4.35)
- 2학기 학기우등 (4.28)
- 한이음 ICT 멘토링 멘티 활동
- 한이음 해상물류 프로젝트 개발 (안드로이드 해상물류 관련 뉴스 피드 앱)
- 교내 학술동아리 C.愛.랑 앱 개발(라떼) 팀장
- 교내 학술동아리 C.愛.랑 하계 SW 워크샵 참여
- 교내 SW Week 동아리 전시회 앱 부분 참여 (해상물류 앱)
- 교내 학술동아리 C.愛.랑 신입생 전공 교육 (자바 프로그래밍)
- 림붕어빵 프로젝트 개발 (리엑트 웹앱 - 붕어빵 위치 지도)
- 교내 SW Week 오픈소스 대회 참여
- 웹 개발 스터디 운영 (팀장)
---
#### 2024
- 1학기 학기우등 (4.38)
- 교내 신입생 전공 멘토링 (자바)
- 교내 학술동아리 C.愛.랑 웹 개발(태그) 팀장
- 교내 학술동아리 C.愛.랑 신입생 전공 교육 (자바 프로그래밍)
- 교내 학술동아리 C.愛.랑 하계 SW 워크샵 참여
- 세월호 10주기 프로젝트 개발 (안드로이드 앱 - 세월호 기억교실 외주)
- 한림대 축제 웹 개발 (리엑트 웹앱 - 예약기능을 포함한 축제 웹사이트)
- 교내 SW중심대학사업단 해커톤 최우수상 (리밍 - 프로젝트 팀원 구하는 웹사이트)
- 교내 SW중심대학사업단 이력서 해커톤 은상
- 교내 SW중심대학사업단 C.愛.랑 동아리 전시회 금상(영화 - 축제 웹사이트)
...
- **주요 기능**: 희생자 관련 정보 제공, 관련 뉴스 및 자료 아카이브, 다국어 번역 기능
- **역할**: 메인페이지, 자료실, 후원자목록 등
- **사용 도구**:
  ![Android Studio](https://img.shields.io/badge/Android_Studio-3DDC84?style=flat&logo=android-studio&logoColor=white)
  ![Kotlin](https://img.shields.io/badge/Kotlin-0095D5?style=flat&logo=kotlin&logoColor=white)
  ![Git](https://img.shields.io/badge/Git-F05032?style=flat&logo=git&logoColor=white)
...
## MinigameParadise
- **주제**: 같은 그림 찾기, 숫자 야구 게임 등 간단한 게임을 즐길 수 있는 미니게임 모음집
- **사용 도구**: 
  ![Android Studio](https://img.shields.io/badge/Android_Studio-3DDC84?style=flat&logo=android-studio&logoColor=white)
  ![Kotlin](https://img.shields.io/badge/Kotlin-0095D5?style=flat&logo=kotlin&logoColor=white)
  ![Git](https://img.shields.io/badge/Git-F05032?style=flat&logo=git&logoColor=white)
- **개발 인원**: 2명
- **역할**: 일부 게임 UI 디자인 및 작동 구현

## Rupir
- **주제**: 쫓아오는 괴물을 피해 아이템을 찾고 숲에서 탈출하는 데스크탑용 공포 게임
- **사용 도구**: 
...
|3-2|오픈소스SW개발도구 활용, 오픈소스SW개발도구 이해, 오픈소스 리눅스 실무, 보안솔루션 운영|
|4-1|데이터베이스 시스템, 머신러닝, 운영체제, 컴퓨터네트워크|
|4-2|모바일프로그래밍, 캡스톤디자인, 컴퓨터구조|
